...
#define LOG_MINIMAL(...) _LOG("minimal",LOG_TEXT_BOLD,LOG_TEXT_RESET,__VA_ARGS__)

#if LOGLEVEL > 0
#define LOG_ERROR(...) _LOG("error",LOG_TEXT_BOLDRED,LOG_TEXT_RED,__VA_ARGS__)
#else
#define LOG_ERROR(...)
#endif

#if LOGLEVEL > 1
#define LOG_WARNING(...) _LOG("warning",LOG_TEXT_BOLDYELLOW,LOG_TEXT_YELLOW,__VA_ARGS__)
#else
#define LOG_WARNING(...)
#endif

#if LOGLEVEL > 2
#define LOG_INFO(...) _LOG("info",LOG_TEXT_BOLDGREEN,LOG_TEXT_GREEN,__VA_ARGS__)
#else
#define LOG_INFO(...)
#endif

#if LOGLEVEL > 3
#define LOG_DEBUG(...) _LOG("debug",LOG_TEXT_BOLDBLUE,LOG_TEXT_BLUE,__VA_ARGS__)
#else
#define LOG_DEBUG(...)
#endif
