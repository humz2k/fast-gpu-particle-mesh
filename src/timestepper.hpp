 ...
 *
 * The Timestepper class is responsible for advancing and reversing simulation time steps,
 * and managing related parameters such as scale factor and redshift.
 */
class Timestepper{
    private:
