 ...
 *
 * The Params class is responsible for storing and managing the various parameters
 * required for running a simulation. It includes methods to access these parameters
 * and to output the configuration.
 */
class Params{
    private:
        ...
        double m_ns = 0.963; /**< Spectral index of the primordial power spectrum. */
        double m_w_de = -1.0; /**< Equation of state parameter for dark energy. */
        double m_wa_de = 0.0; /**< Time variation of the equation of state parameter for dark energy. */
        double m_T_cmb = 2.726; /**< Temperature of the cosmic microwave background. */
        double m_neff_massless = 3.04; /**< Effective number of massless neutrino species. */
        double m_neff_massive = 0.0; /**< Effective number of massive neutrino species. */

        double m_omega_baryon; /**< Density parameter for baryons. */
        double m_omega_cb; /**< Combined density parameter for cold dark matter and baryons. */
        ...
        std::unordered_map<int,bool> m_pk_dumps; /**< Map indicating steps to dump power spectrum. */
        std::unordered_map<int,bool> m_particle_dumps; /**< Map indicating steps to dump particles. */

    public:
        /**
         * @brief Constructs a Params object and initializes it with parameters from the given file.
        ...
        /**
         * @brief Gets the time variation of the equation of state parameter for dark energy.
         * @return The time variation of the equation of state parameter for dark energy.
         */
        double wa_de() const;

        /**
         * @brief Gets the combined density parameter for cold dark matter and baryons.
